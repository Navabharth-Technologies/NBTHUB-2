...
const AdminModule = lazy(() => import('superadmin-dashboard/src/App'));
const HRModule = lazy(() => import('human-resource-app/src/App'));
const PMModule = lazy(() => import('pm-manager-dashboard/src/App'));
const EmployeeModule = lazy(() => import('employee/src/App'));
